...
public class MusteriBireyselDto implements Serializable {
	...
	public MusteriBireyselDto(Integer musteriID, String musteriDurum, String musteriAdi, String musteriSoyadi,
	...
	public static MusteriBireyselDto of(Musteri musteri) {
		return new MusteriBireyselDto(musteri.getMusteriID(), musteri.getMusteriDurum(), musteri.getMusteriAdi(), musteri.getMusteriSoyadi(),
