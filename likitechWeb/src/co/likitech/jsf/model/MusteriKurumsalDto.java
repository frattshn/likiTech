...
public class MusteriKurumsalDto {
	...
	public MusteriKurumsalDto(Integer musteriID, String musteriKurumAdi, String musteriVergiNumarasi,
	...
	public static MusteriKurumsalDto of(Musteri musteri) {
		return new MusteriKurumsalDto(musteri.getMusteriID(), musteri.getMusteriKurumAdi(),
